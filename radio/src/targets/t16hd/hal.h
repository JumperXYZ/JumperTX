...
#define INTMODULE_RX_DMA_STREAM            DMA2_Stream2
#define INTMODULE_RX_DMA_STREAM_IRQ        DMA2_Stream2_IRQn
#define INTMODULE_RX_DMA_STREAM_IRQHandler DMA2_Stream2_IRQHandler
#define INTMODULE_RX_DMA_CHANNEL           DMA_Channel_4
